...
for (var i = 0; i < names.length; i++) {
    ...
    if (stars) {
        ...
        // nameWrapper.innerHTML = names[i] + (explanations[i] ? ": " + explanations[i] : "");
        var nameSpan = createElement("span", "name", nameWrapper);
        var explanationSpan = createElement("span", "explanation", nameWrapper);

        nameSpan.innerText = names[i] + (explanations[i] ? ": " : "");
        explanationSpan.innerHTML = explanations[i] ? explanations[i] : "";
    }
